...
function ChromeTabBar({ tabs = [{ title: 'New Tab' }], activeIndex = 0 }: { tabs?: { title: string }[]; activeIndex?: number }) {
  return (
...
export function ChromeWindow({ tabs = [{ title: 'New Tab' }], activeIndex = 0, url = 'example.com', width = 900, height = 600, children }: ChromeWindowProps) {
  return (
    <div
      style={{
        width,
