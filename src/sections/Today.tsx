...
import { Section, DeviceRow, PHONE_BODY, PHONE_HEADER, SCROLL_BODY, CARD, LABEL_KICKER } from '../components/Section';
...
export function Today({
  ...
  return (
    <Section label={t.sectionLabels.today} heading={t.today.heading}>
      <DeviceRow>
        <IOSDevice>
          <div style={sx(PHONE_BODY)}>
            ...
            <div style={sx(SCROLL_BODY)}>
              ...
              <div>
                <div style={sx(LABEL_KICKER)}>{t.today.quickActionsLabel}</div>
              ...
              <div>
                <div style={sx(LABEL_KICKER)}>{t.today.actionCardsLabel}</div>
              ...
              <div style={sx('background:#F6EFE1; border-radius:20px; padding:18px;')}>
                <div onClick={toggleReadyResponses} style={sx('cursor:pointer; display:flex; align-items:center; justify-content:space-between;')}>
                  <div style={sx('font-size:12px; letter-spacing:1px; text-transform:uppercase; font-weight:700; color:#8A6A2E;')}>
                    {t.today.readyResponsesLabel}
                  </div>
